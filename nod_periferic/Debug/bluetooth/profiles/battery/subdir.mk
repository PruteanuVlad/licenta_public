...
bluetooth/profiles/battery/%.o: ../bluetooth/profiles/battery/%.c bluetooth/profiles/battery/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-bluetooth-2f-profiles-2f-battery

clean-bluetooth-2f-profiles-2f-battery:
	-$(RM) ./bluetooth/profiles/battery/battery_service.d ./bluetooth/profiles/battery/battery_service.o

.PHONY: clean-bluetooth-2f-profiles-2f-battery
