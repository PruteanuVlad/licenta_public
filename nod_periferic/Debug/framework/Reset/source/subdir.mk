...
framework/Reset/source/%.o: ../framework/Reset/source/%.c framework/Reset/source/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-framework-2f-Reset-2f-source

clean-framework-2f-Reset-2f-source:
	-$(RM) ./framework/Reset/source/Reset.d ./framework/Reset/source/Reset.o

.PHONY: clean-framework-2f-Reset-2f-source
