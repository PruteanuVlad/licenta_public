...
C_SRCS += \
../framework/Flash/Flash_Adapter.c 

C_DEPS += \
./framework/Flash/Flash_Adapter.d 

OBJS += \
./framework/Flash/Flash_Adapter.o 


# Each subdirectory must supply rules for building sources it contributes
framework/Flash/%.o: ../framework/Flash/%.c framework/Flash/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-framework-2f-Flash

clean-framework-2f-Flash:
	-$(RM) ./framework/Flash/Flash_Adapter.d ./framework/Flash/Flash_Adapter.o

.PHONY: clean-framework-2f-Flash
