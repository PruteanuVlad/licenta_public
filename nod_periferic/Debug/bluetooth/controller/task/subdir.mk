...
C_SRCS += \
../bluetooth/controller/task/ble_controller_task.c 

C_DEPS += \
./bluetooth/controller/task/ble_controller_task.d 

OBJS += \
./bluetooth/controller/task/ble_controller_task.o 


# Each subdirectory must supply rules for building sources it contributes
bluetooth/controller/task/%.o: ../bluetooth/controller/task/%.c bluetooth/controller/task/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-bluetooth-2f-controller-2f-task

clean-bluetooth-2f-controller-2f-task:
	-$(RM) ./bluetooth/controller/task/ble_controller_task.d ./bluetooth/controller/task/ble_controller_task.o

.PHONY: clean-bluetooth-2f-controller-2f-task
