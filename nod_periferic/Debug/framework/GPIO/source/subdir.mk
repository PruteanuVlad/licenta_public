...
C_SRCS += \
../framework/GPIO/source/GPIO_Adapter.c 
...
framework/GPIO/source/%.o: ../framework/GPIO/source/%.c framework/GPIO/source/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-framework-2f-GPIO-2f-source

clean-framework-2f-GPIO-2f-source:
	-$(RM) ./framework/GPIO/source/GPIO_Adapter.d ./framework/GPIO/source/GPIO_Adapter.o

.PHONY: clean-framework-2f-GPIO-2f-source
