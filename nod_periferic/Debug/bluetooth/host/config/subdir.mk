...
bluetooth/host/config/%.o: ../bluetooth/host/config/%.c bluetooth/host/config/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-bluetooth-2f-host-2f-config

clean-bluetooth-2f-host-2f-config:
	-$(RM) ./bluetooth/host/config/ble_globals.d ./bluetooth/host/config/ble_globals.o

.PHONY: clean-bluetooth-2f-host-2f-config
