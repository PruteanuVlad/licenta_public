...
PRIMARY_SERVICE_UUID128(service_sensor, uuid_service_sensor)
    CHARACTERISTIC_UUID128(char_temp, uuid_temp, (gGattCharPropWriteWithoutRsp_c))
        VALUE_UUID128_VARLEN(value_temp, uuid_temp, (gPermissionFlagWritable_c), gAttMaxWriteDataSize_d(gAttMaxMtu_c), 1, 0x00)
	CHARACTERISTIC_UUID128(char_light, uuid_light, (gGattCharPropWriteWithoutRsp_c))
		VALUE_UUID128_VARLEN(value_light, uuid_light, (gPermissionFlagWritable_c), gAttMaxWriteDataSize_d(gAttMaxMtu_c), 1, 0x00)
