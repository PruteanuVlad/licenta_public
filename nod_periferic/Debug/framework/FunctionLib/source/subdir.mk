...
C_SRCS += \
../framework/FunctionLib/source/FunctionLib.c 

C_DEPS += \
./framework/FunctionLib/source/FunctionLib.d 

OBJS += \
./framework/FunctionLib/source/FunctionLib.o 


# Each subdirectory must supply rules for building sources it contributes
framework/FunctionLib/source/%.o: ../framework/FunctionLib/source/%.c framework/FunctionLib/source/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-framework-2f-FunctionLib-2f-source

clean-framework-2f-FunctionLib-2f-source:
	-$(RM) ./framework/FunctionLib/source/FunctionLib.d ./framework/FunctionLib/source/FunctionLib.o

.PHONY: clean-framework-2f-FunctionLib-2f-source
